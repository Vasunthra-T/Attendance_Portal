...
public class TimesheetServiceImpl implements TimesheetService {
    ...
    public String approveEmployee(String empCode, LocalDate workingDate, Approval.Status status) {
        ...
        if (opt.isPresent()) {
            if (opt.get().getApproval().getStatus().equals(Approval.Status.WAITING_FOR_APPROVAL) && (status.equals(Approval.Status.WAITING_FOR_APPROVAL))) {
                opt.get().getApproval().setStatus(Approval.Status.APPROVED);
